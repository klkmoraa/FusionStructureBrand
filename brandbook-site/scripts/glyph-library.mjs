...
/** La marca madre sostiene el sistema; no cuenta como familia de producto. */
export const MOTHER_BRAND_ID = 'nucleo';

/** Las seis familias que se presentan en el atlas maestro de Figma. */
