...
export const GLYPHS: Record<GlyphId, ReactNode> = {
  'project': (
    ...
    <rect x="19" y="19" width="10" height="10" rx="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <path d="M20 6h8v7h-8zM20 35h8v7h-8zM6 20h7v8H6zM35 20h7v8h-7z" stroke="currentColor" />
    </>
  ),
  'quality': (
    <>
    <path d="M8 18h32M8 30h32" stroke="currentColor" strokeDasharray="3 3.5" opacity=".55" />
  ...
  'memo': (
    ...
    <path d="M28 40.5 27 46l4-2 4 2-1-5.5" stroke="var(--glyph-accent, #14171A)" strokeLinejoin="round" />
    </>
  ),
  'exchange': (
    <>
    ...
    <path d="m35 20 5 4-5 4M13 20l-5 4 5 4" stroke="var(--glyph-accent, #14171A)" />
    </>
  ),
  'library': (
    <>
  ...
  'offline': (
    ...
    <path d="M38 6 8 40" stroke="var(--glyph-accent, #14171A)" opacity=".35" />
    </>
  ),
  'assist': (
    <>
  ...
  'solver2d': (
    ...
    <path d="m13 10 2 3 2-3M22 10l2 3 2-3M31 10l2 3 2-3" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <path d="M11 21c8 0 6 9 13 9s5-9 13-9" stroke="var(--glyph-accent, #14171A)" />
  ...
  'solver3d': (
    ...
    <circle cx="24" cy="24" r="3.4" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <path d="M24 24 36 18M24 24l-9 9M24 24v-9" stroke="var(--glyph-accent, #14171A)" />
    </>
  ),
  'fem': (
    <>
    ...
    <path d="M18 20h11v9H18z" fill="var(--glyph-accent, #14171A)" stroke="none" opacity=".9" />
  ...
  'materials': (
    ...
    <path d="M38 42V14" stroke="var(--glyph-accent, #14171A)" strokeWidth="7" strokeLinecap="butt" opacity=".85" />
    <path d="M23 14h20" stroke="var(--glyph-accent, #14171A)" strokeDasharray="3 3" />
    </>
  ),
  'cad': (
    <>
    <path d="M9 32 20 17l8 6 11-13" stroke="currentColor" />
    <path d="M9 41h30M11 38v6M37 38v6" stroke="var(--glyph-accent, #14171A)" opacity=".8" />
    <path d="m15 41 4-2v4zM33 41l-4-2v4z" fill="var(--glyph-accent, #14171A)" stroke="none" />
  ...
  'bim': (
    ...
    <path d="M16 24h16v12H16z" fill="var(--glyph-accent, #14171A)" stroke="none" opacity=".9" />
    <path d="M6 12v24M42 12v24" stroke="var(--glyph-accent, #14171A)" />
    <circle cx="32" cy="12" r="2.6" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'detail': (
    <>
    ...
    <path d="M6 17h12M6 31h12M12 17v14" stroke="var(--glyph-accent, #14171A)" opacity=".55" />
    <circle cx="22.5" cy="15" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="26.5" cy="15" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="22.5" cy="24" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="26.5" cy="24" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="22.5" cy="33" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="26.5" cy="33" r="2" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'terrain': (
    <>
    <path d="M6 32c8-9 12 3 20-4s10-9 16-13" stroke="currentColor" opacity=".55" />
    ...
    <circle cx="24" cy="12" r="3" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'geotech': (
    <>
    <path d="M6 15h36M6 25h36M6 35h36M6 15v27h36V15" stroke="currentColor" opacity=".5" />
    <path d="M6 15h36" stroke="currentColor" />
    <path d="M10 20h6M28 20h6M10 30h5M30 30h6M10 39h8" stroke="currentColor" opacity=".4" />
    <path d="M21 10h6v28h-6z" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <path d="M17 10h14" stroke="var(--glyph-accent, #14171A)" strokeWidth="3" />
    <path d="m36 21-3-4h6z" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'water': (
    <>
    <path d="M8 10v11a5 5 0 0 0 5 5h13a5 5 0 0 1 5 5v9" stroke="currentColor" />
    <path d="M31 26h9" stroke="currentColor" />
    <circle cx="8" cy="10" r="3.4" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="31" cy="40" r="3.4" fill="var(--glyph-accent, #14171A)" stroke="none" />
    <circle cx="26" cy="26" r="3" stroke="var(--glyph-accent, #14171A)" />
    <path d="M6 38c4-3 6 3 10 0s6 3 10 0" stroke="var(--glyph-accent, #14171A)" opacity=".7" />
  ...
  'docs': (
    ...
    <path d="M27 34a5 5 0 0 1 10 0c0 4-5 9-5 9s-5-5-5-9z" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'cost': (
    <>
    ...
    <path d="M24 24h13M24 31h9" stroke="var(--glyph-accent, #14171A)" strokeWidth="4" strokeLinecap="butt" />
  ...
  'schedule': (
    <>
    <path d="M8 12h16M14 21h18M8 30h12" stroke="currentColor" strokeWidth="5" strokeLinecap="butt" />
    <path d="m34 26 5 5-5 5-5-5z" fill="var(--glyph-accent, #14171A)" stroke="none" />
  ...
  'connectors': (
    ...
    <path d="m26 18 3 3-3 3M22 24l-3 3 3 3" stroke="var(--glyph-accent, #14171A)" />
  ...
  'classroom': (
    ...
    <path d="M9 15c8 0 7 13 15 13s7-13 15-13" stroke="currentColor" opacity=".45" strokeDasharray="3.5 3.5" />
    <path d="M9 15c8 0 7 21 15 21s7-21 15-21" stroke="var(--glyph-accent, #14171A)" />
    <path d="m6 20 3-5 3 5zM36 20l3-5 3 5z" fill="currentColor" stroke="none" />
  ...
  'research': (
    ...
    <path d="m21 16-7 15M27 16l7 15M15.5 35h17" stroke="var(--glyph-accent, #14171A)" />
  ...
  'lab': (
    ...
    <path d="M18 26v6M24 21v11M30 26v6M36 29v3" stroke="var(--glyph-accent, #14171A)" />
    <circle cx="24" cy="24" r="2.4" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
  'mentoring': (
    <>
    ...
    <path d="M36 9h9l-3 4 3 4h-9z" fill="var(--glyph-accent, #14171A)" stroke="none" />
    </>
  ),
};
