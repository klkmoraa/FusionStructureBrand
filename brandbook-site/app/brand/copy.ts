...
export const MATERIAL_COPY = {
  ...
  en: {
    ...
    tableReview: 'review',
    and: 'and',
    describeCalculation: 'describe the calculation;',
    moduleAvailable: 'Available',
    moduleExperimental: 'Experimental',
    describeModule: 'describe the module.',
    today: 'today',
    rule: 'All light enters from the top left and no surface has its own light: depth is singular, shared, and therefore readable.',
  },
} as const;
...
export const REFERENCE_COPY = {
  es: {
    atlasAria: 'Referencias Clay seleccionadas',
    atlasNote: 'Tres imágenes base · sólo superficies funcionales',
  ...
  en: {
    atlasAria: 'Selected Clay references',
    atlasNote: 'Three base images · functional surfaces only',
