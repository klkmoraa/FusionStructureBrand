...
export const PATTERN_COPY = {
  es: {
    field: 'Campo de interfaz · Solver2D',
    desktop: 'Escritorio',
    mobile: 'Móvil',
    view: 'Vista del patrón',
    solverTitle: 'Solver2D · Análisis Estructural 2D',
    solverBadge: 'Análisis · FS-A01',
    solverSubtitle: 'Pórtico Plano 2D · 12.00 × 4.20 m · IPE 300',
    node: 'Nudo',
    member: 'Miembro',
    support: 'Apoyo',
    sectionTool: 'Sección',
    ...
    layerModel: 'Modelo',
    layerLoads: 'Cargas',
    layerMoment: 'Momento M',
    layerDeformed: 'Deformada Δ',
    elementTitle: 'Miembro M-02 (Dintel)',
    connectivity: 'N2 (0.00, 4.20) → N3 (12.00, 4.20)',
    profile: 'IPE 300 · Acero A992',
    ratio: 'Ratio D/C: 0.68 · OK',
    model: 'Modelo',
    loads: 'Cargas',
    results: 'Resultados',
    trace: 'Traza',
    ...
    axial: 'Axil N',
    shear: 'Cortante V',
    capacityRatio: 'Ratio de capacidad D/C',
    gridStatus: 'Grilla activa · Ajuste ortogonal',
    units: 'kN · m · °C (SI)',
    canvasPrompt: 'Geometría lista · Ejecuta el solver para resultados',
    states: 'Cuatro estados obligatorios',
    statesBody:
      'Toda superficie debe diseñar los cuatro antes de considerarse terminada.',
    stateLegend: 'Estado del solver',
    rule: 'Orientar, actuar, comprobar y continuar. Si una pantalla no permite las cuatro, le falta una.',
    snap: 'ajuste 0.25 m',
  },
  en: {
    field: 'Interface field · Solver2D',
    desktop: 'Desktop',
    mobile: 'Mobile',
    view: 'Pattern view',
    solverTitle: 'Solver2D · 2D Structural Analysis',
    solverBadge: 'Analysis · FS-A01',
    solverSubtitle: '2D Plane Frame · 12.00 × 4.20 m · IPE 300',
    node: 'Node',
    member: 'Member',
    support: 'Support',
    sectionTool: 'Section',
    ...
    layerModel: 'Model',
    layerLoads: 'Loads',
    layerMoment: 'Moment M',
    layerDeformed: 'Deformed Δ',
    elementTitle: 'Member M-02 (Beam)',
    connectivity: 'N2 (0.00, 4.20) → N3 (12.00, 4.20)',
    profile: 'IPE 300 · Steel A992',
    ratio: 'D/C Ratio: 0.68 · OK',
    model: 'Model',
    loads: 'Loads',
    results: 'Results',
    trace: 'Trace',
    ...
    axial: 'Axial N',
    shear: 'Shear V',
    capacityRatio: 'Capacity ratio D/C',
    gridStatus: 'Active grid · Orthogonal snap',
    units: 'kN · m · °C (SI)',
    canvasPrompt: 'Geometry ready · Run solver to view results',
    states: 'Four required states',
    statesBody:
      'Every surface must design all four before it is considered complete.',
    stateLegend: 'Solver state',
    rule: 'Orient, act, verify, and continue. If a screen cannot do all four, one is missing.',
    snap: 'snap 0.25 m',
  },
} as const;

export const RESULT_CARDS_COPY = {
  es: {
    sectionTag: 'COMPONENTE DE INTERFAZ · TARJETAS TÁCTILES',
    sectionTitle: 'Tarjetas de resultados: síntesis háptica y claridad estructural',
    sectionDescription:
      'Fichas modales que concentran magnitudes críticas, diagramas de solicitación y verificación de estados límite sobre superficies de arcilla física.',
    specimenTitle: 'Muestra interactiva de tarjetas',
    dayClay: 'Día · Arcilla Papel',
    nightClay: 'Noche · Obsidiana',
    closeCard: 'Cerrar resultados',
    tabMoment: 'Momento M',
    tabShear: 'Cortante V',
    tabAxial: 'Axial N',
    tabDeformed: 'Deformada u',
    tabState: 'Estado & Confiabilidad',
    convention: 'Convención',
    length: 'Longitud',
    units: 'Unidades',
    inspectorTitle: 'Resultados',
    moment: {
      subtitle: 'Diagrama de momento flector (M)',
      card1Title: 'Momento flector máximo',
      card1Value: '+24.36 kN·m',
      card1Note: 'A 0.45 m del empotramiento',
      card2Title: 'Estado',
      card2Value: 'Controlado',
      card2Note: 'Cumple con los criterios de diseño',
      card3Title: 'Confiabilidad',
      card3Value: 'Confiabilidad limitada',
      card3Note: 'Se recomienda revisión y refuerzo',
      metadata: 'Longitud 3.00 m · Convención: fibra inferior traccionada · Unidades: kN·m',
    },
    shear: {
      subtitle: 'Diagrama de cortante (V)',
      card1Title: 'Cortante máx. positivo',
      card1Value: '+12.80 kN',
      card1Note: 'En el nudo de apoyo interior',
      card2Title: 'Cortante máx. negativo',
      card2Value: '−12.80 kN',
      card2Note: 'En la sección del empotramiento',
      card3Title: 'Cortante en el extremo libre',
      card3Value: '0.00 kN',
      card3Note: 'Condición de contorno verificada',
      metadata: 'Longitud 3.00 m · Convención: + hacia arriba · Unidades: kN',
    },
    axial: {
      subtitle: 'Diagrama axial (N)',
      maxTitle: 'Axial máximo',
      maxValue: '0.00 kN',
      maxNote: 'En el extremo libre',
      minTitle: 'Axial mínimo',
      minValue: '−18.40 kN',
      minNote: 'En el empotramiento',
      minBadge: 'Compresión',
      signTitle: 'Signo positivo',
      signValue: '← █ →',
      signBadge: 'Tensión',
      metadata: 'Longitud 3.00 m · Convención: + Tensión / − Compresión · Unidades: kN',
      note: 'El diagrama axial representa la fuerza normal interna a lo largo del eje de la barra.',
    },
    deformed: {
      subtitle: 'Deformada (u)',
      card1Title: 'Desplazamiento relativo',
      card1Value: '−12.80 mm',
      card1Note: 'En el extremo libre',
      card2Title: 'Ubicación del desp. máximo',
      card2Value: '3.00 m',
      card2Note: 'Desde el empotramiento',
      card3Title: 'Rotación en el extremo libre',
      card3Value: '−0.245°',
      card3Note: 'Sentido horario',
      card4Title: 'Reacciones en el empotramiento',
      card4Value: 'Vertical: +12.80 kN · Momento: +38.40 kN·m',
      card4Note: 'Equilibrio estático cerrado (1e-6)',
      metadata: 'Longitud 3.00 m · Flecha límite L/250 = 12.00 mm · Alerta de servicio',
    },
  },
  en: {
    sectionTag: 'INTERFACE COMPONENT · TACTILE CARDS',
    sectionTitle: 'Result cards: haptic synthesis and structural clarity',
    sectionDescription:
      'Modal sheets concentrating critical magnitudes, internal force diagrams, and limit state verifications on physical clay surfaces.',
    specimenTitle: 'Interactive cards specimen',
    dayClay: 'Day · Paper Clay',
    nightClay: 'Night · Obsidian',
    closeCard: 'Close results',
    tabMoment: 'Moment M',
    tabShear: 'Shear V',
    tabAxial: 'Axial N',
    tabDeformed: 'Deformed u',
    tabState: 'Status & Reliability',
    convention: 'Convention',
    length: 'Length',
    units: 'Units',
    inspectorTitle: 'Results',
    moment: {
      subtitle: 'Bending moment diagram (M)',
      card1Title: 'Max bending moment',
      card1Value: '+24.36 kN·m',
      card1Note: 'At 0.45 m from support',
      card2Title: 'Status',
      card2Value: 'Controlled',
      card2Note: 'Meets design criteria',
      card3Title: 'Reliability',
      card3Value: 'Limited reliability',
      card3Note: 'Review and reinforcement recommended',
      metadata: 'Length 3.00 m · Convention: bottom fiber in tension · Units: kN·m',
    },
    shear: {
      subtitle: 'Shear force diagram (V)',
      card1Title: 'Max positive shear',
      card1Value: '+12.80 kN',
      card1Note: 'At interior support joint',
      card2Title: 'Max negative shear',
      card2Value: '−12.80 kN',
      card2Note: 'At support section',
      card3Title: 'Shear at free end',
      card3Value: '0.00 kN',
      card3Note: 'Verified boundary condition',
      metadata: 'Length 3.00 m · Convention: + upward · Units: kN',
    },
    axial: {
      subtitle: 'Axial force diagram (N)',
      maxTitle: 'Max axial',
      maxValue: '0.00 kN',
      maxNote: 'At free end',
      minTitle: 'Min axial',
      minValue: '−18.40 kN',
      minNote: 'At support',
      minBadge: 'Compression',
      signTitle: 'Positive sign',
      signValue: '← █ →',
      signBadge: 'Tension',
      metadata: 'Length 3.00 m · Convention: + Tension / − Compression · Units: kN',
      note: 'The axial diagram represents the internal normal force along the member axis.',
    },
    deformed: {
      subtitle: 'Deformed shape (u)',
      card1Title: 'Relative displacement',
      card1Value: '−12.80 mm',
      card1Note: 'At free end',
      card2Title: 'Location of max displacement',
      card2Value: '3.00 m',
      card2Note: 'From support',
      card3Title: 'Rotation at free end',
      card3Value: '−0.245°',
      card3Note: 'Clockwise direction',
      card4Title: 'Reactions at support',
      card4Value: 'Vertical: +12.80 kN · Moment: +38.40 kN·m',
      card4Note: 'Closed static equilibrium (1e-6)',
      metadata: 'Length 3.00 m · Allowable deflection L/250 = 12.00 mm · Service alert',
    },
  },
} as const;
